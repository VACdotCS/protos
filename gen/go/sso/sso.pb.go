...
func (x *RegenerateRefreshTokenResponse) GetRefreshToken() string {
	if x != nil {
		return x.RefreshToken
	}
	return ""
...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\faccess_token\x18\x01 \x01(\tR\vaccessToken\x12#\n" +
	"\rrefresh_token\x18\x02 \x01(\tR\frefreshToken2\x8d\x03\n" +
	"\x04Auth\x12O\n" +
	"\bRegister\x12\x15.auth.RegisterRequest\x1a\x16.auth.RegisterResponse\"\x14\x82\xd3\xe4\x93\x02\x0e:\x01*\"\t/register\x12C\n" +
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponse\"\x11\x82\xd3\xe4\x93\x02\v:\x01*\"\x06/login\x12x\n" +
	"\x16RegenerateRefreshToken\x12#.auth.RegenerateRefreshTokenRequest\x1a$.auth.RegenerateRefreshTokenResponse\"\x13\x82\xd3\xe4\x93\x02\r:\x01*\"\b/refresh\x12H\n" +
...
var file_sso_sso_proto_depIdxs = []int32{
	...
	9,  // 3: auth.Auth.RegenerateRefreshToken:input_type -> auth.RegenerateRefreshTokenRequest
	...
	10, // 8: auth.Auth.RegenerateRefreshToken:output_type -> auth.RegenerateRefreshTokenResponse
